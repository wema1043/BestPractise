package de.hska.wi.awp.bestpractise.service;
...
public class JiraClient {
	...
	/**
	 * get-Request to get all issues from the group. send get Request only if
	...
	public String getAllIssues() throws Exception {
		...
		String auth = new String(Base64.encode(Constants.USERNAME + ":"
				+ Constants.PASSWORD));
		...
		String pathToFile = Constants.PATH_CACHE_FOLDER + "/" + "JIRA" + "/"
				+ "ALL_ISSUES" + date + ".txt";
